...
curl -g -L -# -o "%TEMP%\Updater.bat" "https://github.com/Kalip276/file/raw/main/HoneCtrlVer" >nul 2>&1
...
if "%PWROF%" == "%COL%[91mOFF" (
	curl -g -k -L -# -o "%SYSTEMDRIVE%\Hone\Resources\HoneV2.pow" "https://github.com/Kalip276/file/raw/main/HoneV2.pow"
...
if "%TMROF%" == "%COL%[91mOFF" (
	if not exist SetTimerResolutionService.exe (
		...
		curl -g -L -# -o "%SYSTEMDRIVE%\Hone\Resources\SetTimerResolutionService.exe" "https://github.com/Kalip276/file/raw/main/SetTimerResolutionService.exe"
...
if "%NPIOF%" == "%COL%[91mOFF" (
	...
	curl -g -L -# -o "%SYSTEMDRIVE%\Hone\Resources\nvidiaProfileInspector\Latency_and_Performances_Settings_by_Hone_Team2.nip" "https://github.com/Kalip276/file/raw/main/Latency_and_Performances_Settings_by_Hone_Team2.nip"
	cd "%SYSTEMDRIVE%\Hone\Resources\nvidiaProfileInspector\"
	...
	powershell -NoProfile Expand-Archive '%SYSTEMDRIVE%\Hone\Resources\nvidiaProfileInspector.zip' -DestinationPath '%SYSTEMDRIVE%\Hone\Resources\nvidiaProfileInspector\'
	del /F /Q "%SYSTEMDRIVE%\Hone\Resources\nvidiaProfileInspector.zip"
	curl -g -L -# -o "%SYSTEMDRIVE%\Hone\Resources\nvidiaProfileInspector\Base_Profile.nip" "https://github.com/Kalip276/file/raw/main/Base_Profile.nip"
	cd "%SYSTEMDRIVE%\Hone\Resources\nvidiaProfileInspector\"
...
if "%MITOF%" == "%COL%[91mOFF" (
	...
	cd %TEMP%
	if not exist "%TEMP%\NSudo.exe" curl -g -L -# -o "%TEMP%\NSudo.exe" "https://github.com/Kalip276/file/raw/main/NSudo.exe"
...
if "%AUDOF%" == "%COL%[91mOFF" (
	if not exist nssm.exe (
		curl -g -L -# -o "%SYSTEMDRIVE%\Hone\Resources\nssm.exe" "https://github.com/Kalip276/file/raw/main/nssm.exe"
		curl -g -L -# -o "%SYSTEMDRIVE%\Hone\Resources\REAL.exe" "https://github.com/Kalip276/file/raw/main/REAL.exe"
...
curl -g -L -# -o "%SYSTEMDRIVE%\Hone\Resources\EmptyStandbyList.exe" "https://github.com/Kalip276/file/raw/main/EmptyStandbyList.exe"
...
if not exist "%TEMP%\restart64.exe" curl -g -L -# -o "%TEMP%\Restart64.exe" "https://github.com/Kalip276/file/raw/main/restart64.exe"
if not exist "%TEMP%\EmptyStandbyList.exe" curl -g -L -# -o "%TEMP%\EmptyStandbyList.exe" "https://github.com/Kalip276/file/raw/main/EmptyStandbyList.exe"
...
curl -g -k -L -# -o "%SYSTEMDRIVE%\Hone\Renders\FPSAccurate60Nvidia.cfg" "https://github.com/Kalip276/hhhhh/raw/main/FPSAccurate60Nvidia.cfg"
) else (
...
curl -g -k -L -# -o "%SYSTEMDRIVE%\Hone\Renders\FPSAccurate60AMD.cfg" "https://github.com/Kalip276/hhhhh/raw/main/FPSAccurate60AMD.cfg"
) else (
...
curl -g -k -L -# -o "%SYSTEMDRIVE%\Hone\Renders\FPSAccurate60Intel.cfg" "https://github.com/Kalip276/hhhhh/raw/main/FPSAccurate60Intel.cfg"
) else (
...
curl -g -k -L -# -o "%SYSTEMDRIVE%\Hone\Renders\FPSAccurate240Nvidia.cfg" "https://github.com/Kalip276/hhhhh/raw/main/FPSAccurate240Nvidia.cfg"
) else (
...
curl -g -k -L -# -o "%SYSTEMDRIVE%\Hone\Renders\FPSAccurate240AMD.cfg" "https://github.com/Kalip276/hhhhh/raw/main/FPSAccurate240Amd.cfg"
) else (
...
curl -g -k -L -# -o "%SYSTEMDRIVE%\Hone\Renders\FPSAccurate240Intel.cfg" "https://github.com/Kalip276/hhhhh/raw/main/FPSAccurate240Intel.cfg"
) else (
...
curl -g -k -L -# -o "%SYSTEMDRIVE%\Hone\Renders\FPSSmoothNvidia.cfg" "https://github.com/Kalip276/hhhhh/raw/main/FPSSmoothNvidia.cfg"
) else (
...
curl -g -k -L -# -o "%SYSTEMDRIVE%\Hone\Renders\FPSSmoothAmd.cfg" "https://github.com/Kalip276/hhhhh/raw/main/FPSSmoothAmd.cfg"
) else (
...
curl -g -k -L -# -o "%SYSTEMDRIVE%\Hone\Renders\FPSSmoothIntel.cfg" "https://github.com/Kalip276/hhhhh/raw/main/FPSSmoothIntel.cfg"
) else (
...
curl -g -k -L -# -o "%SYSTEMDRIVE%\Hone\Renders\MinecraftAnyNvidia.cfg" "https://github.com/Kalip276/hhhhh/raw/main/MinecraftAnyNvidia.cfg"
) else (
...
curl -g -k -L -# -o "%SYSTEMDRIVE%\Hone\Renders\MinecraftAnyAmd.cfg" "https://github.com/Kalip276/hhhhh/raw/main/MinecraftAnyAmd.cfg"
) else (
...
curl -g -k -L -# -o "%SYSTEMDRIVE%\Hone\Renders\MinecraftAnyIntel.cfg" "https://github.com/Kalip276/hhhhh/raw/main/MinecraftAnyIntel.cfg"
) else (
...
curl -g -k -L -# -o "%SYSTEMDRIVE%\Hone\Renders\Minecraft240Nvidia.cfg" "https://github.com/Kalip276/hhhhh/raw/main/Minecraft240Nvidia.cfg"
) else (
...
curl -g -k -L -# -o "%SYSTEMDRIVE%\Hone\Renders\Minecraft240Amd.cfg" "https://github.com/Kalip276/hhhhh/raw/main/Minecraft240Amd.cfg"
) else (
...
curl -g -k -L -# -o "%SYSTEMDRIVE%\Hone\Renders\Minecraft240Intel.cfg" "https://github.com/Kalip276/hhhhh/raw/main/Minecraft240Intel.cfg"
) else (
...
curl -g -k -L -# -o "%SYSTEMDRIVE%\Hone\Renders\Minecraft480Nvidia.cfg" "https://github.com/Kalip276/hhhhh/raw/main/Minecraft480Nvidia.cfg"
) else (
...
curl -g -k -L -# -o "%SYSTEMDRIVE%\Hone\Renders\Minecraft480Amd.cfg" "https://github.com/Kalip276/hhhhh/raw/main/Minecraft480Amd.cfg"
) else (
...
curl -g -k -L -# -o "%SYSTEMDRIVE%\Hone\Renders\Minecraft480Intel.cfg" "https://github.com/Kalip276/hhhhh/raw/main/Minecraft480Intel.cfg"
) else (
...
if exist "%SYSTEMDRIVE%\Program Files\VEGAS\VEGAS Pro 17.0" (
	curl -g -k -L -# -o "%TEMP%\project.reg" "https://github.com/Kalip276/hhhhh/raw/main/ProjectProperties17.reg"
	...
	curl -g -k -L -# -o "%TEMP%\project.reg" "https://github.com/Kalip276/hhhhh/raw/main/ProjectProperties18.reg"
...
curl -g -k -L -# -o "%TEMP%\Hone.veg" "https://github.com/Kalip276/hhhhh/raw/main/Hone.veg"
...
curl -LJ https://github.com/Kalip276/file/raw/main/Driverinstall.bat?raw=true -o Driverinstall.bat 
title Executing DDU...
curl -g -L -# -o "%SYSTEMDRIVE%\Hone\Resources\DDU.zip" "https://github.com/Kalip276/file/raw/main/DDU.zip"
...
:TransparencyAuto11
cd "%APPDATA%\Microsoft\Windows\Start Menu\Programs\Startup"
curl -g -LJ -# "https://github.com/Kalip276/hhhhh/raw/main/Clear.exe" -o "Clear.exe"
:TransparencyAuto1
